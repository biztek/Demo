...
@Component({
  selector: 'app-counts-reports',
  templateUrl: './counts-reports.component.html',
  styleUrls: ['./counts-reports.component.scss']
})
export class CountsReportsComponent implements OnInit {
