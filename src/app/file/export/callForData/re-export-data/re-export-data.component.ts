...
@Component({
  selector: 'app-re-export-data',
  templateUrl: './re-export-data.component.html',
  styleUrls: ['./re-export-data.component.scss']
})
export class ReExportDataComponent implements OnInit {
